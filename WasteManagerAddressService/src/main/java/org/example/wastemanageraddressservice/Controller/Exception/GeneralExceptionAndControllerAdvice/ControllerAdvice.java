...
import org.example.wastemanageraddressservice.Controller.Errors.Errors;
import org.example.wastemanageraddressservice.Controller.Exception.BDExcepcion.AccessBDException;
import org.example.wastemanageraddressservice.Controller.Exception.BDExcepcion.NotExistException;
import org.example.wastemanageraddressservice.Controller.Exception.ClassException.ArgumentInvalidException;
import org.example.wastemanageraddressservice.Controller.Exception.ClassException.EmptyFieldException;
import org.example.wastemanageraddressservice.Controller.Exception.ClassException.IncorrectFieldException;
...
public class ControllerAdvice {
    ...
    public ResponseEntity<HashMap<String, String>> handlerUnexpectedType(UnexpectedTypeException ex){
        Throwable cause = ex.getCause();
        String localizedMessage = cause == null ? "" : cause.getLocalizedMessage();
        hashMap = new HashMap<>();
